...
<div class="row s-header__inner">
    ...
    <ul>
                        <li class="current"><a href="header.php#intro" class="smoothscroll">Intro</a></li>
                        <li><a href="index.php#about" class="smoothscroll">About</a></li>
                        <li><a href="index.php#pricing" class="smoothscroll">Pricing</a></li>
                        <li><a href="index.php#blog" class="smoothscroll">Blog</a></li>
                    </ul>
    </nav>
    <?php if(!isset($_SESSION['client'])) { ?>
        <div class="s-header__cta ">
        <li><a href="SignUp.php#subscribe" class="btn btn--primary s-intro__content-btn smoothscroll">Sign Up</a></li> 
        </div>
        <div class="s-header__cta">
        <li><a href="SignIn.php#sign" class="btn btn--primary s-intro__content-btn smoothscroll">Sign In</a></li>
        </div>

    <?php  }else{   ?>
        <div class="s-header__cta">
        <li><a href="MyProfile.php#testimonials" class="btn btn--primary s-intro__content-btn smoothscroll"> My Profil</a>
        </div>

    <div class="s-header__cta">
    <li><a href="Deconnexion.php#sign" class="btn btn--primary s-intro__content-btn smoothscroll">Deconnexion</a>
    </div>
